...
Создать метод getScholarship() для класса Student, который возвращает сумму стипендии. Если средняя оценка студента равна 4 или 5, то сумма 2000 руб, иначе 1900.
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(aspirant.firstName +  " " + aspirant.getScholarship());
    }
}